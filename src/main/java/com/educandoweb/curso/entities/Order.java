 ...
 * transformado em cadeia de Dados para ser 
 * gravados em arquivos etc..
 */
...
//formantando o Json para o timezone GMT

	@JsonFormat(shape = JsonFormat.Shape.STRING, pattern = "yyyy-MM-dd'T'HH:mm:ss'Z'", timezone = "GMT")
	private Instant moment;
// chamando o status do pedido		
...
/*Metodo para fazer a soma de todos 
 * pedidos items  
 */
