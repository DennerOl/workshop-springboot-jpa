...
public class TestConfig implements CommandLineRunner {
	...
	/* classe de configuraçoes de JPA (somente perfil teste)
	* aqui vou popular meu banco de dados com auxilio da classe 
	* do repositories injecoes de dependencia
	*/
		@Autowired
...
// aqui eu falo de qual categoria é tal produto
	...
	// aqui passo uma lista de objtos para ser salvos no banco	
		...
		// na hora de salvar associo o pedido ao pagamento e depois salvo
